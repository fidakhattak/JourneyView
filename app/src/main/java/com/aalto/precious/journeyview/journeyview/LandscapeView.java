...
public class LandscapeView extends View {
    ...
    private static String jsonFile = "journey.json";
    ...
    public LandscapeView(Context mContext, Utilities.LandscapeType landscapeType) {
        ...
        switch(landscapeType) {
            case FOREST:
                landscapeDirectory = "FOREST/";
                break;
            case OCEAN:
                landscapeDirectory = "OCEAN/";
                break;
            case MOUNTAIN:
            default:
                landscapeDirectory = "MOUNTAIN/";
                break;
        }
        try {
            jsonString = Utilities.loadJSONFromAsset(context, landscapeDirectory+jsonFile);
            ...
            svgPath = SVG.getFromAsset(context.getAssets(), landscapeDirectory + "path.svg");
        }
